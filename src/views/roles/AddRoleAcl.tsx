  ...
  useEffect(() => {
    const fetchOptions = () => {
      roleAclsService.getRoles().then(res => {
        if (res.success && res.data) { const rows = Array.isArray(res.data) ? res.data : res.data.rows; setRoles(rows || []); }
      ...
      <div className="xui-py-1">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="xui-form">
          <div className="xui-d-grid xui-grid-col-1 xui-md-grid-col-2 xui-grid-gap-2">
            <div>
              <div className="xui-form-box" {...(errors.role_unique_id && { 'xui-error': 'true' })}>
