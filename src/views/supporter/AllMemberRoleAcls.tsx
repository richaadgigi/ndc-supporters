        ...
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          ...
          <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-half">
            ...
            {canAdd && (
              <>
                <button
                  onClick={() => router.push('/dashboard/supporter/member-role-acls/add-multiple')}
                  className="xui-btn xui-btn-text xui-font-sz-80 xui-bdr-rad-half xui-font-w-500 xui-d-flex xui-flex-ai-center xui-grid-gap-half"
                ...
                <button
                  onClick={() => router.push('/dashboard/supporter/member-role-acls/add')}
                          ...
                          <td>
                            <div className="xui-tooltip" xui-set="left">
                              ...
                              <div className="xui-tooltip-content xui-flex-ai-center xui-grid-gap-half" style={{ display: 'flex', maxWidth: '500px' }}>
                                {canEdit && (
                                  <button onClick={() => router.push(`/dashboard/supporter/member-role-acls/edit/${acl.unique_id}`)} className="xui-btn xui-btn-small xui-d-flex xui-flex-ai-center xui-grid-gap-half xui-cursor-pointer xui-font-sz-80" style={{ backgroundColor: 'var(--info-light)', border: 'none', color: 'var(--info)' }}><Edit size={16} /> Edit</button>
                                )}
                                {canDelete && (
