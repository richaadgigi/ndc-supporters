...
const EditMemberRole = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (response.success) { setSuccessMessage('Member role updated successfully'); showAlert('success-alert'); setTimeout(() => router.push('/dashboard/supporter/member-roles'), 1500); }
