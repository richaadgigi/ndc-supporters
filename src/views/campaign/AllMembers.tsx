    ...
    <div>
      ...
      <div className="xui-py-1-half">
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          ...
          <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-half">
            ...
            {canAdd && (
              <button
                onClick={() => router.push('/dashboard/campaign/members/add')}
                ...
                <tbody>
                  {members.map((member) => (
                    <tr key={member.unique_id}>
                      ...
                      <td className="xui-font-sz-85">{member.Candidate?.name || <span className="xui-opacity-4">None</span>}</td>
                      <td>
                        {member.MemberRole ? (
      ...
      <ExportModal
        ...
        columns={[
          ...
          { key: 'Candidate.name', header: 'Candidate' },
